...
<div role="status">
    <svg aria-hidden="true" className="r w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function SupplyDemand() {
    ...
    const tickers = {"alberta_internal_load": "Alberta Internal Load",
    ...
    const [tickerList, setTickerList] = useState(
      Object.values(tickers).map(x => <Ticker title={x} text={<LoadingWheel/>}/>)
    );
